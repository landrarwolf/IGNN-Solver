...
initfile = os.path.join(thisfolder, 'config/', str(args.labelrate) + 'flickr.ini')
...
nfadj = row_normalize(fadj + sp.eye(fadj.shape[0]))  
...
# A = torch.zeros(idx_train.size(0), num_class) 
